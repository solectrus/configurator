...
InfluxDB wird ebenfalls über \`https\` verfügbar sein, allerdings auf einem anderen Port, du erreichst InfluxDB über \`https://%{domain}:8086\`.
`;export{e as default};